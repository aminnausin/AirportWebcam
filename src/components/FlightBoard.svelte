<script>
    ...
    const handleUpdate = () => {
	    ...
	    lastUpdate = weeks > 0 ? `${weeks} week${weeks > 1 ? 's' : ''} ago` : days > 0 ? `${days} day${days > 1 ? 's' : ''} ago` : hours > 0 ? `${hours} hour${hours > 1 ? 's' : ''} ago` : minutes > 0 ? `${minutes}m ago` : `${seconds}s ago`
        loadFlightData();
    };
...
<div class="block-tableauVols">
    <div class="tableauxvols-automaticupdate-wrapper overflow-hidden flex justify-between items-start" >
        <div data-enhance="automaticUpdate" class="flex flex-wrap items-center" data-automaticupdate-receiverevent="tableauvols-start" data-automaticupdate-type="serverside" data-automaticupdate-triggeredevent="tableauvols-update" data-automaticupdate-start="false" data-automaticupdate-trigger=".tableauvols-automaticupdate-trigger" style="color: #ffffff;">
            <div class="font-bold text-xl w-full align-middle tableauxvols-automaticupdate-label" id="airportIDHeader">
                YUL Flight Information     
            </div>
    ...
    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper tableauvols-wrapper">
        ...
        <div class="dataTables_scrollHead ui-state-default overflow-hidden relative border-0 w-full pb-5 z-10">
        ...
        <div class="dataTables_scrollBody" style="overflow: auto; height: 600px; width: 100%; position: static;">
    ...
    <div class="tableauvols-resize withShadow" style="display: block;">
        <div>
